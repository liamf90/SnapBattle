...
class BattlesReportedViewModelFactory (private val context: Context, private val reportingsRepository: ReportingsRepository
) : ViewModelProvider.NewInstanceFactory() {


    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return BattlesReportedViewModel(context, reportingsRepository) as T
    }
