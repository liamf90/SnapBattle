...
class BattlesReportedViewModelFactory @Inject constructor(private val reportingsRepository: ReportingsRepository
) : ViewModelProvider.NewInstanceFactory() {


    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return BattlesReportedViewModel(reportingsRepository) as T
    }
