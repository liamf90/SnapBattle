...
public class BattleNameSearchFragment extends Fragment implements android.support.v7.widget.SearchView.OnQueryTextListener
{
    ...
    public void setQueryChangeListener(android.support.v7.widget.SearchView searchView)
    {
