...
public class VideoController extends FrameLayout {
     ...
     * @param view The view to which to anchor the mVideoController when it is visible.
     */
     ...
     * @return The mVideoController view.
     * @hide This doesn't work as advertised
     */
    protected View makeControllerView() {
        LayoutInflater inflate = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mRoot = inflate.inflate(getMediaControllerLayout(), null);
    ...
    protected void initControllerView(View v) {
        ...
        mProgressSpinner = v.findViewById(R.id.progressBar);
    ...
    /**
     * Show the mVideoController on screen. It will go away
     ...
     * the mVideoController until hide() is called.
     */
    public void show(int timeout) {
        if (!mShowing && mAnchor != null) {
            ...
            FrameLayout.LayoutParams tlp = new FrameLayout.LayoutParams(
                    ...
                    //THIS IS WHERE WE SET WHERE IT GOES!!
                    //Gravity.BOTTOM
    ...
    /**
     * Remove the mVideoController from the screen.
     */
    public void hide() {
        if (mAnchor == null) {
            return;
    ...
    public boolean onTrackballEvent(MotionEvent ev) {
        ...
        if (!mShowing && ev.getAction() == MotionEvent.ACTION_DOWN)
        {
    ...
    private View.OnClickListener mPauseListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Log.i("VideoControllerView", "pause button pressed");
            doPauseResume();
            show(sDefaultTimeout);
        }
    };
    ...
    public void updatePausePlay() {
        Log.i("YAHOO", "M is here");
        if (mRoot == null || mPauseButton == null || mPlayer == null) {
            return;
        }
        Log.i("YAHOO", "M is playing: " + mPlayer.isPlaying());
        if (mPlayer.isPlaying()) {

            mPauseButton.setImageResource(R.drawable.ic_media_pause);
            mProgressSpinner.setVisibility(View.GONE);
        } else {
            mPauseButton.setImageResource(R.drawable.ic_media_play_vector);
            mProgressSpinner.setVisibility(View.GONE);
        }
    }
